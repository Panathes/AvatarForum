...
// local testing, to delete 

$filename = "wallpapers/test.jpg";
list($width, $height, $type) = getimagesize($filename);
$old_image = load_avatar($filename, $type);

$new_avatar = resize_avatar(100, 100, $old_image, $width, $height);

save_avatar($new_avatar, 'wallpapers/resized-'.basename($filename), 'jpeg', 75);

// TODO
// insert into database the path of resized avatar
